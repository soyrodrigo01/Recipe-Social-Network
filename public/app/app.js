(function() {
    ...
    function authConfig(
        ...
        $stateProvider.state('search', {
            url: '/search',
            templateUrl: 'app/views/partials/partial-search.html',
            controller: 'SearchController as searchC'
        });
        ...
        $stateProvider.state('editinfo', {
            url: '/editinfo',
            templateUrl: 'app/views/partials/partial-editinfo.html',
            controller: 'EditinfoController as eic'
        });
        
        $stateProvider.state('addrecipe', {
            url: '/addrecipe',
            templateUrl: 'app/views/partials/partial-add-recipe.html',
            controller: 'AddRecipeController as arc'
        });
